...
# ===========================================================================
HOST = "uditgupta347"   # shown as  uditgupta347@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full-Stack Developer"),
    ("kv", "Prev", "Independent Project Developer"),
    ("kv", "Edu", "B.Tech Undergraduate"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, JavaScript"),
    ("kv", "Backend", "Flask, MySQL"),
    ("kv", "Core", "C++, Git"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "14+ production-style projects across web development"),
    ("bul", "Strong documentation and polished project presentation"),
    ("bul", "Regular GitHub activity"),
]
